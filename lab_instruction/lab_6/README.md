...
2. Mengimplementasikan Calculator
    ...
    4. [x] Implementasi fungsi `AC`.
	   ...
	   (4. Jika tombol AC ditekan, maka print.value diubah menjadi string kosong)
...
3.  Mengimplementasikan select2
    ...
    4. [x] Warna berubah ketika theme dipilih
	   ...
	   (1. Jika web pertama kali dikunjungi (selectedItem == null), maka warna indigo)
	   (3. Ketika tombol diklik, key dan value akan dimasukkan ke localStorage)
	   (4. CSS document diubah)
